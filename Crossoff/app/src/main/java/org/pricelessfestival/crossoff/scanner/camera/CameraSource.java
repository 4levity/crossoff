...
public class CameraSource {
    ...
    private Camera createCamera() {
        ...
        } else if (parameters.getSupportedFocusModes() != null && parameters.getSupportedFocusModes().contains(Camera.Parameters.FOCUS_MODE_MACRO)) {
            parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_MACRO);
        } else {
            Log.e(TAG, "Failed to set autofocus or macro focus, not supported on this device.");
        }

        List<String> supportedFlashModes = parameters.getSupportedFlashModes(); // supported flash modes can be null
        if (supportedFlashModes != null && supportedFlashModes.contains(Camera.Parameters.FLASH_MODE_TORCH)) {
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
        } else {
            Log.w(TAG, "Camera flash mode: " + Camera.Parameters.FLASH_MODE_TORCH + " is not supported on this device.");
        }
